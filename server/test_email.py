import asyncio
import logging
from app.utils.email_service import send_seller_application_status_email
...
async def test_email():
    """Test sending an email using the email service."""
    logger.info("Starting email test...")
    
    # Test email parameters
    test_email = "produktoelyukalph@gmail.com"  # Use your own email for testing
    ...
    # Send the test email
    result = await send_seller_application_status_email(
        email=test_email,
